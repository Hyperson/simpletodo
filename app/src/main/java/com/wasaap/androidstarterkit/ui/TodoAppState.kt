...
import com.wasaap.androidstarterkit.navigation.TopLevelDestination
...
class TodoAppState(
    ...
    fun navigateToTopLevelDestination(topLevelDestination: TopLevelDestination) {
        ...
        when (topLevelDestination) {
            TopLevelDestination.TODOS -> navController.navigate(TodosBaseRoute, topLevelNavOptions)
            TopLevelDestination.SETTINGS -> navController.navigate(
                SettingsRoute,
                topLevelNavOptions
            )
        }
